 ...
 * 
 * @author Shahriar (Shawn) Emami and Gabriel Araujo
 * @version Jan 13, 2019
 */
...
//		});
	...
	public void addSampleShapes() {
		PolyShape s = new PolyShape().setPoints(0, 0, 0, 640, 700, 640, 700, 0);
		s.getDrawable().setFill(Color.WHITE).setStroke(Color.BLACK).setWidth(1.5);
		shapes.add(s);
